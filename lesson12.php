<div class="tab-pane" id="tab12">
  <article class="lesson12">
    ...
    <div class="glyphiconss">
        ...
        <div class="glyphicons">
          <ul class="glyphicons-list">
            ...
            <li>
              ...
              <span class="glyphicon-class">glyphicon <br>glyphicon-asterisk</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span class="glyphicon-class">glyphicon <br>glyphicon-envelope</span>
            </li>
            <li>
              <span class="glyphicon glyphicon-pencil"></span>
              <span class="glyphicon-class">glyphicon <br>glyphicon-pencil</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span class="glyphicon-class">glyphicon <br>glyphicon-music</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span class="glyphicon-class">glyphicon <br>glyphicon-user</span>
            </li>
            <li>
              <span class="glyphicon glyphicon-film"></span>
              <span class="glyphicon-class">glyphicon <br>glyphicon-film</span>
            </li>
            <li>
      ...
      <!-- bootstrap glyph exmaple -->
      <div class="col-md-12">
        <h3>
          Glyphicon Example
        </h3>
        <p>
          We can use them in navigation, form inputs, buttons, button groups and more!.
        </p>
        ...
        <div class="well well-sm">    
          <code>
            <?php include('code/lesson12/basic_icon_button.php'); ?>
          </code>     
        </div>
      </div>
    ...
    <div class="font_awesome">
      ...
      <div class="row fontawesome-icon-list">
        <h3>Newest Font Awesome Icons</h3>
      ...
      <div class="col-md-12">
        ...
        <p>
          ...
          <code>fa</code>
          and the icon's name. Font Awesome is designed to be used with inline elements (we like the
          <code>&lt;i&gt;</code>
      ...
      <div class="col-md-12">
        ...
        <div class="well well-sm">    
          <code>
            <?php include('code/lesson12/larger.php'); ?>
          </code>     
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="well well-sm">    
          <code>
            <?php include('code/lesson12/fixed.php'); ?>
          </code>     
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="well well-sm">    
          <code>
            <?php include('code/lesson12/list.php'); ?>
          </code>     
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="well well-sm">    
          <code>
            <?php include('code/lesson12/pulled.php'); ?>
          </code>     
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="well well-sm">    
          <code>
            <?php include('code/lesson12/spin.php'); ?>
          </code>     
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="well well-sm">    
          <code>
            <?php include('code/lesson12/fliped.php'); ?>
          </code>     
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <p>
          ...
          &lt;a href="#larger"&gt;larger icon</a>
          classes on the parent to get further control of sizing. 
        </p>
        <div class="table_example">
        ...
        <div class="well well-sm">    
          <code>
            <?php include('code/lesson12/stacked.php'); ?>
          </code>     
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="well well-sm">    
          <code>
            <?php include('code/lesson12/bootstrap_example.php'); ?>
          </code>     
        </div>
      </div>
