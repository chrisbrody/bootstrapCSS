        ...
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
          <form role="form">
            <div class="form-group">
              ...
              <p class="help-block">Etiam venenatis, metus vitae semper suscipit, lorem erat feugiat mauris, quis tempor nibh metus non lacus. Integer eget tincidunt leo. </p>
            </div>
            <div class="form-group">
              <label>Email</label>
            ...
            <div class="form-group">
              <label>Subject</label>
              <input type="text" class="form-control">
              <p class="help-block">Morbi sollicitudin tortor ultricies enim auctor interdum. In sed feugiat sapien. Curabitur ornare, erat sed egestas malesuada, dui metus hendrerit ipsum, accumsan varius mi neque id enim.</p>
            </div>
            <div class="form-group">
